...
enum URL {
    ...
    register = '/myapp/admin/user/register',
...
const registerApi = async (data: any) => post<any>({ url: URL.register, params: {}, data: data, headers: { 'Content-Type': 'multipart/form-data;charset=utf-8' } });
...
export { loginApi, listApi, detailApi, createApi, registerApi, updateApi, deleteApi, userLoginApi, userRegisterApi, updateUserPwdApi, updateUserInfoApi};
